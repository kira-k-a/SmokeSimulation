...
This is the readme for SmokeSimulation, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. SmokeSimulation) > Ok.
...
- To run the project find SmokeSimulation.java (which will be in under src/main/java/smokesimulation) and right click > Run 'SmokeSimulation'
